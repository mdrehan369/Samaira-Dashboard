...
function Overview() {
    ...
    const generateClasses = (color) => {
        return `w-[20%] h-[30%] p-4 ${color} text-black flex flex-col items-center rounded-md text-xl font-bold text-center`
    }
    ...
    return (
        !loader ?
            <Container className='flex w-[85vw] items-start justify-start gap-6 p-10'>
